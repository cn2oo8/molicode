    ...
    <div>
        <Modal v-model="showModal"
            ...
            <Form ref="formItems" :model="formItems" :rules="formRules" :label-width="120" inline>
                ...
                <Row>
                    <Col span="24">
                        <Form-item label="被复制的项目id" prop="id" style="width: 90%">
                ...
                <Row>
                    <Col span="24">
                        <Form-item label="被复制的项目key" prop="projectKey" style="width: 90%">
                ...
                <Row>
                    <Col span="24">
                        <Form-item label="备注" prop="remark" style="width: 90%">
                            <Input v-model="formItems.remark" :maxlength="500" type="textarea"
                                   :autosize="{minRows: 2,maxRows: 5}" :disabled="disableInput"></Input>
                        </Form-item>
                    </Col>
                </Row>
                ...
                <Row>
                    <Col span="24">
                        <Form-item label="是否默认" prop="setDefault" style="width: 90%">
                            <dict-radio v-model="setDefault" :disabled="disableInput"
        ...
        methods: {
            save: function () {
                this.$refs['formItems'].validate((valid) => {
                    ...
                    var _this = this;
                    let promise = this.$store.dispatch(constants.types.COPY_PROJECT, {
                        project: this.formItems,
                        _vue: this,
                    ...
                    promise.then((data) => {
                        ...
                        _this.$emit(constants.actions.common.refreshList);
                    });
                });
            },
            'cancel': function () {
